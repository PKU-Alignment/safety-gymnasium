...
- The algorithms are tested with the same hyperparameters which are default in [OmniSafe](https://github.com/OmniSafeAI/omnisafe/tree/main/omnisafe/configs/on-policy).
...
- The `Racecar` and `Ant` agents are newly added in `Safety-Gymnasium`, We are currently fine-tuning the physical parameters of these agents to make them more realistic and more compatible with various tasks. If you find any issues when using them, please feel free to open an issue, and we are welcome to PRs.
...
<center>
    ...
    display: inline-block;
    color: #999;
    padding: 2px;">SafetyPointGoal0-v0(1e7)</div>
</center>
...
<center>
    ...
    display: inline-block;
    color: #999;
    padding: 2px;">SafetyCarGoal0-v0(1e7)</div>
</center>
...
<center>
    ...
    display: inline-block;
    color: #999;
    padding: 2px;">SafetyPointButton0-v0(1e7)</div>
</center>
...
<center>
    ...
    display: inline-block;
    color: #999;
    padding: 2px;">SafetyCarButton0-v0(1e7)</div>
</center>
...
<center>
    ...
    display: inline-block;
    color: #999;
    padding: 2px;">SafetyPointPush0-v0(1e7)</div>
</center>
...
<center>
    ...
    display: inline-block;
    color: #999;
    padding: 2px;">SafetyPointPush1-v0(1e7)</div>
</center>
...
<center>
    ...
    display: inline-block;
    color: #999;
    padding: 2px;">SafetyPointPush2-v0(1e7)</div>
</center>
...
<center>
    ...
    display: inline-block;
    color: #999;
    padding: 2px;">SafetyCarPush0-v0(1e7)</div>
</center>
...
<center>
    ...
    display: inline-block;
    color: #999;
    padding: 2px;">SafetyCarPush1-v0(1e7)</div>
</center>
...
<center>
    ...
    display: inline-block;
    color: #999;
    padding: 2px;">SafetyCarPush2-v0(1e7)</div>
</center>
...
<center>
    ...
    display: inline-block;
    color: #999;
    padding: 2px;">SafetyPointCircle0-v0(1e7)</div>
</center>
...
<center>
    ...
    display: inline-block;
    color: #999;
    padding: 2px;">SafetyPointCircle1-v0(1e7)</div>
</center>
...
<center>
    ...
    display: inline-block;
    color: #999;
    padding: 2px;">SafetyPointCircle2-v0(1e7)</div>
</center>
...
<center>
    ...
    display: inline-block;
    color: #999;
    padding: 2px;">SafetyCarCircle0-v0(1e7)</div>
</center>
...
<center>
    ...
    display: inline-block;
    color: #999;
    padding: 2px;">SafetyCarCircle1-v0(1e7)</div>
</center>
...
<center>
    ...
    display: inline-block;
    color: #999;
    padding: 2px;">SafetyCarCircle2-v0(1e7)</div>
</center>
