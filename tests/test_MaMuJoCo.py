...
from safety_gymnasium import mamujoco_v0
...
def test_general(observation_depth, task) -> None:
    ...
    parallel_api_test(
        ...
        mamujoco_v0.parallel_env(task.scenario, task.conf, agent_obsk=observation_depth),
...
def test_action_and_observation_mapping(observation_depth, task):
    ...
    test_env = mamujoco_v0.parallel_env(task.scenario, task.conf, agent_obsk=observation_depth)
