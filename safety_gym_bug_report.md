  ...
  <tbody>
    <tr class="row-odd">
      <td>
        <figure class="align-default">
          <img
              alt="https://github.com/zmsn-2077/safety-gymnasium-zmsn/raw/HEAD/images/bug_report/detect_high_lying_0.jpeg"
              src="https://github.com/zmsn-2077/safety-gymnasium-zmsn/raw/HEAD/images/bug_report/detect_high_lying_0.jpeg" style="width: 230px;">
        </figure>
        <p class="centered">
      ...
      <td>
        <figure class="align-default">
          <a class="reference external image-reference"><img
              alt="https://github.com/zmsn-2077/safety-gymnasium-zmsn/raw/HEAD/images/bug_report/detect_high_lying_1.jpeg"
              src="https://github.com/zmsn-2077/safety-gymnasium-zmsn/raw/HEAD/images/bug_report/detect_high_lying_1.jpeg" style="width: 230px;"></a>
        </figure>
        <p class="centered">
    ...
    <tr class="row-even">
      <td>
        <figure class="align-default">
          <a class="reference external image-reference"><img
              alt="https://github.com/zmsn-2077/safety-gymnasium-zmsn/raw/HEAD/images/bug_report/detect_low_lying_0.jpeg"
              src="https://github.com/zmsn-2077/safety-gymnasium-zmsn/raw/HEAD/images/bug_report/detect_low_lying_0.jpeg" style="width: 230px;"></a>
        </figure>
        <p class="centered">
      ...
      <td>
        <figure class="align-default">
          <a class="reference external image-reference" href="./button#button2"><img
              alt="https://github.com/zmsn-2077/safety-gymnasium-zmsn/raw/HEAD/images/bug_report/detect_low_lying_1.jpeg"
              src="https://github.com/zmsn-2077/safety-gymnasium-zmsn/raw/HEAD/images/bug_report/detect_low_lying_1.jpeg" style="width: 230px;"></a>
        </figure>
        <p class="centered">
