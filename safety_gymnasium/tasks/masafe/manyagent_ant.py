...
class ManyAgentAntEnv(mujoco_env.MujocoEnv, utils.EzPickle):
    ...
    def __init__(self, **kwargs) -> None:
        ...
        asset_path = os.path.join(
            ...
            'assets',
            f'manyagent_ant_{n_agents}_agents_each_{n_segs_per_agents}_segments.auto.xml',
        )
        # if not os.path.exists(asset_path):
        print(f'Auto-Generating Manyagent Ant asset with {n_segs} segments at {asset_path}.')
